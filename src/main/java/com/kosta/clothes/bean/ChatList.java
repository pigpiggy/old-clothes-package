...
public class ChatList {
	...
	public ChatList(Integer chatno, Integer ino, Integer sellerno, Integer buyerno, String fileName,
			Timestamp createdDate, String sellerName, String buyerName, int chatReadBuy, int chatReadSell,
			String ititle, String content, String sendTime, String senderName) {
		super();
		this.chatno = chatno;
		this.ino = ino;
		this.sellerno = sellerno;
