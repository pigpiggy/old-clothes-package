...
public class Donation {
	...
	public Donation(Long bno, String dname, String daddress, String dphone, double lngx, double laty, String dfile) {
		super();
		this.bno = bno;
		this.dname = dname;
		this.daddress = daddress;
