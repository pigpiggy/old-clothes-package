...
public interface BusinessDAO {
	...
	/*
	 * List<Business> selectCatereview(Map<String, String> map) throws Exception;
	 * //카테고리 정렬 로그인 안 했을 때 (review) List<Business> selectCatehigh(Map<String,
	 * String> map) throws Exception; //카테고리 정렬 로그인 안 했을 때 (high) List<Business>
	 * selectCatelow(Map<String, String> map) throws Exception; //카테고리 정렬 로그인 안 했을 때
	 * (low)
	 */	
