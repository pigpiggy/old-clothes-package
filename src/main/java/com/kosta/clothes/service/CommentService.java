...
public interface CommentService {
	//자유게시판
	public void registUcomment(Comments comments, Integer fno) throws Exception; //댓글등록[개인]
	public void registBcomment(Comments comments, Integer fno) throws Exception; //댓글등록[사업자]
