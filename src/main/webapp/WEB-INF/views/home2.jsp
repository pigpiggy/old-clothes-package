                                    ...
                                    <ul class="custom-list mt-2">
                                        <li class="custom-list-item d-flex">
                                            <div class="custom-text-box-icon me-2" style="display:flex; justify-content:center; align-items:center;">
	                                            <img src="/static/image/mainrecycling.png" style="width:13px;">
                                        	</div>
                                            헌 옷 수거함 찾기
                                        </li>
                                        <li class="custom-list-item d-flex">
                                        	<div class="custom-text-box-icon me-2" style="display:flex; justify-content:center; align-items:center;">
	                                            <img src="/static/image/mainheart.png" style="width:13px;">
                                        	</div>                                           
                                        	기부처 안내	
                                        </li>
                                        <li class="custom-list-item d-flex">
                                        	<div class="custom-text-box-icon me-2" style="display:flex; justify-content:center; align-items:center;">
	                                            <img src="/static/image/mainbox.png" style="width:13px;">
                                        	</div>                                           
                                        	무료 나눔	
                                        </li>
                                        ...
                                        <li class="custom-list-item d-flex">
                                            <div class="custom-text-box-icon me-2" style="display:flex; justify-content:center; align-items:center;">
	                                            <img src="/static/image/maindollar.png" style="width:14px;">
                                        	</div>                                           
                                       		대량 및 소량 판매
                                        </li>
                                    </ul>
