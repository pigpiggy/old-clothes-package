...
<body>	
	...
	var list = []; //좋아요 정보를 저장할 배열
	list = document.getElementById("list").value;
	console.log("list" + list.ContentText);
	...
	$('#searchBtn').click(function(){
		...
		success: function(data){
			...
			bli += "<ul id='a'>"
				...
				if(${authUser== null}){
					bli += '<img src="/image/heart.png" id="heart_img" alt="찜 신청전">';
				}else if(${authUser.sect.equals("business")}){
					bli += '';
				}else{
				...
				bli += '</li>' ;
				var businaddress = data[i].baddress+data[i].bdetailadd;
